...
String devId = "D0003"; // idname
const char *apName = "ESP8266_AP_D0003";
...
// func list
#define FUNC_NUM 3
String funcName[FUNC_NUM] = {"电源", "音量", "显示内容"};
String funcDesc[FUNC_NUM] = {"控制设备的电源", "控制设备的音量",
                             "设置设备显示的文本"};
